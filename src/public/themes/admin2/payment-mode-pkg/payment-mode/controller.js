    ...
    controller: function($http, $location, HelperService, $scope, $routeParams, $rootScope, $location) {
        ...
        var dataTable = $('#payment_modes_list').DataTable({
            ...
            stateLoadCallback: function(settings) {
                ...
                if (state_save_val) {
                    $('#search_payment_mode').val(state_save_val.search.search);
                }
            ...
            scrollCollapse: true,
            ajax: {
                url: url(laravel_routes['getPaymentModeList']),
                type: "GET",
                dataType: "json",
                data: function(d) {
                    d.payment_mode_code = $('#payment_mode_code').val();
                    d.payment_mode_name = $('#payment_mode_name').val();
            ...
            columns: [
                ...
                { data: 'code', name: 'payment_modes.code' },
                { data: 'name', name: 'payment_modes.name' },
                { data: 'mobile_no', name: 'payment_modes.mobile_no' },
                { data: 'email', name: 'payment_modes.email' },
            ],
...
app.component('paymentModeForm', {
    ...
    controller: function($http, $location, HelperService, $scope, $routeParams, $rootScope) {
        get_form_data_url = typeof($routeParams.id) == 'undefined' ? payment_mode_get_form_data_url : payment_mode_get_form_data_url + '/' + $routeParams.id;
        var self = this;
        self.hasPermission = HelperService.hasPermission;
        ...
        $scope.onSelectedCountry = function(id) {
            payment_mode_get_state_by_country = vendor_get_state_by_country;
            $http.post(
                payment_mode_get_state_by_country, { 'country_id': id }
            ).then(function(response) {
                // console.log(response);
        ...
        $scope.onSelectedState = function(id) {
            payment_mode_get_city_by_state = vendor_get_city_by_state
            $http.post(
                payment_mode_get_city_by_state, { 'state_id': id }
            ).then(function(response) {
                // console.log(response);
